...
@Component({
  selector: 'app-media-file-modal-ad',
  templateUrl: './media-file-modal-ad.component.html',
  styleUrls: ['./media-file-modal-ad.component.scss']
})

export class MediaFileModalAdComponent implements OnInit {
